...
function StepThree({ handleNext, updateObject, object, handleBack }) {
    ...
    return (
        ...
        <Grid>
            <Grid className='bgthree'>
                <Typography pb={"1rem"} variant='h5'>Token & onChain</Typography>

                <Typography sx={{ background: '#fff' }} width='fit-content' variant='subtitle2' textAlign={"left"}>Identify if Whales or VC's have shown interest for the project</Typography>

                <ul>
                    <li>
                        <Typography sx={{ background: '#fff' }} width='fit-content' variant='body2' textAlign="left"> <a href='https://defillama.com/raises' rel="noreferrer" target="_blank">DefiLlama</a> for the raises.</Typography>
                    </li>
                    <li>
                        <Typography sx={{ background: '#fff' }} width='fit-content' variant='body2' textAlign="left">Find the best in this list of <a href='https://messari.io/governor/tools' rel="noreferrer" target="_blank">tools</a> used by DAO's</Typography>
                    </li>
                    <li>
                        <Typography sx={{ background: '#fff' }} width='fit-content' variant='body2' textAlign="left"> <a href='https://dune.com/browse/dashboards' rel="noreferrer" target="_blank">Dune</a> for the last infos</Typography>
                    </li>
                    <li>
                        <Typography sx={{ background: '#fff' }} width='fit-content' variant='body2' textAlign="left"> <a href='https://app.artemis.xyz/developers/on-chain' rel="noreferrer" target="_blank">Artemis</a> helps to compare the Mainnet Deployments</Typography>
                    </li>


                </ul>
                <Typography sx={{ background: '#fff' }} width='fit-content' variant='subtitle2' textAlign={"left"}>Metrics</Typography>
                <Grid justifyContent={"center"} display="flex" p={"1rem"} flexDirection="column">
                    <FormControl sx={{ background: '#fff' }} fullWidth>
            ...
            <Stack pt={"2rem"} gap="1rem" >
                <Typography sx={{ background: '#fff' }} width='fit-content' variant='h6'>Confirm all informations you have about the project thrid-party</Typography>
                ...
                />
                <Typography sx={{ background: '#fff' }} width='fit-content' fontFamily='monospace !important' variant='caption'>Single wallet owns +5% of the supply</Typography>
                ...
                />
                <Typography sx={{ background: '#fff' }} width='fit-content' textAlign='left' fontFamily='monospace !important' variant='caption'>
                    MAX : Team 15% | Advisors 10% | Early investors 25% |<br></br> Public sale 10% | Marketing 10% | Ecosystem 10% | Liquidity 20%
                    <br></br>
                    MIN : Treasury 15%
                ...
                />
                <Typography sx={{ background: '#fff' }} width='fit-content' fontFamily='monospace !important' variant='caption'>Twitter ratio subscribers/average tweet views between 10 and 20 %</Typography>
                <Divider variant='middle' />
                <FormControlLabel sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}
                    control={
                        <Checkbox
                    ...
                    label="Red Flag ?"
                />
                <Typography sx={{ background: '#fff' }} width='fit-content' fontFamily='monospace !important' variant='caption'>Absence of a whitepaper, Lack of a roadmap, background is unknown, no identified target groups, Poor behavior...</Typography>
            </Stack>
